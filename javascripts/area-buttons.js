// "use strict";
// console.log("area-buttons.js, Yo!");

// //when the button is clicked, we want to match the button ID with the area ID and pull the JSON file from firebase that matches both IDs.
// var areaDataInfo = {};
// var areaID = "";
// let themePark = [];
