...
let regexHolder = 
                    {
                        "9 AM": /([^1][9]:)([0-5][0-9][a])\w+/ig,
                        "10 AM": /([1][0]:)([0-5][0-9][a])\w+/ig,
                        "11 AM": /([1][1]:)([0-5][0-9][a])\w+/ig,
                        "12 PM": /([1][2]:)([0-5][0-9][p])\w+/ig,
                        "1 PM": /([^1][1]:)([0-5][0-9][p])\w+/ig,
                        "2 PM": /([^1][2]:)([0-5][0-9][p])\w+/ig,
                        "3 PM": /([^1][3]:)([0-5][0-9][p])\w+/ig,
                        "4 PM": /([^1][4]:)([0-5][0-9][p])\w+/ig,
                        "5 PM": /([^1][5]:)([0-5][0-9][p])\w+/ig,
                        "6 PM": /([^1][6]:)([0-5][0-9][p])\w+/ig,
                        "7 PM": /([^1][7]:)([0-5][0-9][p])\w+/ig,
                        "8 PM": /([^1][8]:)([0-5][0-9][p])\w+/ig,
                        "9 PM": /([^1][9]:)([0-5][0-9][p])\w+/ig
                    };
